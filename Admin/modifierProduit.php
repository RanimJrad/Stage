...
<body>
								...
								<div class="col-md-6">
									<select id="marque" name="marque" class="form-select" onchange="afficherModeles()"
										...
										<option value="Honda" <?= ($res['marqueVoiture'] == 'Honda') ? 'selected' : '' ?>>
											Honda</option><!-- /.option-->
										<option value="Hyundai" <?= ($res['marqueVoiture'] == 'Hyundai') ? 'selected' : '' ?>>Hyundai</option><!-- /.option-->
										<option value="Mercedes-Benz" <?= ($res['marqueVoiture'] == 'Mercedes-Benz') ? 'selected' : '' ?>>Mercedes-Benz</option><!-- /.option-->
										<option value="Opel" <?= ($res['marqueVoiture'] == 'Opel') ? 'selected' : '' ?>>
											Opel</option><!-- /.option-->
	...
	<script>
		var modelesParMarque = {
			...
			mercedes: ["Classe C", "Classe E", "GLC"]
		};
